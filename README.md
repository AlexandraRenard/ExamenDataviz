...
Voici un résumé de mes manipulations. J'vais en tête d'ajouter d'autres informations complémentaires sur le tableau dans OpenRefine, mais par manque de temps et d'expérience, cela n'a pas été possible. 
